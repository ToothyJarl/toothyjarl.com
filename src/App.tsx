                        ...
                        <div className="relative w-36 h-36 lg:w-52 lg:h-52 mb-4">
                            <ProfileDropdown>
                                <img
                                    src={profile}
                                    alt="Profile"
                                    className="w-full h-full rounded-full object-cover cursor-pointer transition-transform duration-300 ease-in-out hover:scale-[98px]"
                                />
                            </ProfileDropdown>
                        </div>
                    </BlurFade>
                    <BlurFade delay={0.3}>
                        <h1 className="text-white text-2xl lg:text-4xl font-bold text-center mb-2">
